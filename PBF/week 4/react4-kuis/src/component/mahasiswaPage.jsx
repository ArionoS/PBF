...
const mahasiswaPage = (props) => {
        return(
           <div className="row container-fluid text-center">
                        ...
                        <div className="col-1 border border-dark p-1"><button className="btn btn-sm btn-danger" onClick={() => props.hapusMahasiswa(props.NIM)}>Hapus</button></div>
           </div>  
        );
}
